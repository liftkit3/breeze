...
1. **M1 S10** — Pause Picker + Gemini API Edge Function (~4h, the "magic" of the product). Replaces the `/pause-coming-soon` stub Home currently routes to. Spec: `Stopit/PAUSE_PICKER_SPEC.md`.
